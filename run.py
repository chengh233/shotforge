...
USAGE = ("usage: python run.py <setup|genref|train|frames|verify|manga|video|talk|stillclip|dub|subs|lipsync|post|stitch> "
...
def main() -> None:
    ...
    elif stage in ("frames", "video", "lipsync", "talk"):   # compose + pluggable engines

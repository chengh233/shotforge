...
CAMERAS: dict[str, str] = {
    ...
    "handheld": "轻微手持晃动感",
    # —— 预告片/电影感运镜 ——
    "slow_push": "镜头极缓慢而有张力地推近，预告片式的逼近感",
    "crane_up": "镜头缓缓升起并略微俯瞰，展开宏大的画面",
    "crane_down": "镜头从高处缓缓下降、逼近主体",
    "orbit": "镜头缓缓环绕主体旋转，富有电影感",
    "dolly_in": "镜头沿地面平稳向前推进、逐渐逼近主体",
    "whip_pan": "镜头快速横向甩动（甩镜转场）",
}
